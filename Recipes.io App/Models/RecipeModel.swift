...
extension Recipe {
    static let all: [Recipe] = [
        Recipe (
            ...
            image: "https://github.com/KrystalZhang612/images-attachments-collection/blob/main/creamy-carrot-soup.PNG",
        ...
        Recipe (
            ...
            image: "https://github.com/KrystalZhang612/images-attachments-collection/blob/main/Kale-Apple-and-Quinoa-Salad.PNG",
        ...
        Recipe (
            ...
            image: "https://github.com/KrystalZhang612/images-attachments-collection/blob/main/Kale-Bruschetta.PNG",
        ...
        Recipe (
            name:
            "Vegetable Pot Pie",
            image: "https://github.com/KrystalZhang612/images-attachments-collection/blob/main/Vegetable-pie.PNG",
        ...
        Recipe (
            ...
            image: "https://github.com/KrystalZhang612/images-attachments-collection/blob/main/Red-Lentil-Loaf-with-Smoky-Tomato-Sauce-Recipe.PNG",
            ...
            category: "Main", datePublished: "2019-03-19",
        ...
        Recipe (
            ...
            image: "https://github.com/KrystalZhang612/images-attachments-collection/blob/main/Roasted-Root-Vegetable-Medley.PNG",
        ...
        Recipe (
            ...
            image: "https://github.com/KrystalZhang612/images-attachments-collection/blob/main/Raspberry%20Truffle%20Brownies.PNG",
            ...
            directions: "Preheat the oven to 3509F. Line an 8 x 8-inch pan with a 10-inch square of parchment paper or have ready an 8 x 8-inch nonstick or silicone baking pan. InMelt the chocolate in either a double boiler or the microwave. Set aside.\nIn a large mixing bowl, vigorously mix together the jam, sweetener, and applesauce. Stir in the vanilla, almond extract, and the melted chocolate.InSift in the flour, cocoa powder, baking powder, baking soda, and salt. Mix very well until a stiff dough forms. Fold in the raspberries. Spread the mixture into the prepared pan. It will be very thick; you'll need to use your hands to even the batter out in the pan. \nBake the brownies for 16 to 18 minutes. Remove them from the oven and let cool completely. These taste especially good and fudgy after being refrigerated for a few hours. In\nNote: The brownies are still very gooey after the baking time is complete, but don't worry-that's what you want with brownies! Gooey out of the oven means that they will be nice and fudgy when they cool. Allow them to cool completely and chill in the fridge for a few hours for best results.",
            category: "Dessert",
